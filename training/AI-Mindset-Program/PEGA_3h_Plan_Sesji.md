...
**Deck:** `Decks/PL/PEGA_Sesja_3h.html` (33 slajdy, bez przełącznika ścieżek — cała talia uszyta pod ankietę; slajdy 1, 20 i 33 są ciemne: otwarcie, przerwa, zamknięcie).
**Cel biznesowy dnia:** sala ma wyjść z poczuciem „to było o NAS” + na stole leży konkretny, nazwany warsztat 2 (slajd 32). Sprzedaje personalizacja i dema, nie pitch.
...
| 2:30–2:45 | Weryfikacja + dane wrażliwe + Lidka | 27–29 | Lidkę można opowiedzieć w 60 s |
| 2:45–2:55 | Ćwiczenie: jedno zadanie od poniedziałku (kartki) | 30 | **nigdy nie wycinać** — mechanika dnia 30 i pretekst kontaktu |
| 2:55–3:00 | Mapa + warsztat 2 + zamknięcie + ankieta | 31–33 | nie skracać — to moment sprzedażowy |
...
- Narzędzie: Perplexity lub asystent z wyszukiwaniem. Klient przykładowy: **publiczna** marka realistyczna dla PEGA (np. duży producent sprzętu gamingowego obecny w PL). Nie używaj prawdziwego prospekta PEGA bez zgody na sali.
...
2. Slajd 32 nazywa cztery warsztaty **imiennie pod ludzi z ankiety** — oferta podana jako plan rozwoju zespołu, nie cennik. O pieniądzach na sali nie rozmawiasz; „format i wycenę wyślę w mailu do 48 h — dzisiejsza ankieta decyduje, który temat pierwszy”.
3. Ankieta po sesji (do 24 h, wg runbooka) musi zawierać pytanie: „Który temat warsztatu 2 najbardziej pomógłby Ci w pracy?” — upsell staje się ich wyborem.
4. Mail follow-up (do 48 h): materiały + prompty z dem + odpowiedzi z flipchartu + **jedna strona oferty warsztatu 2** (temat wybrany ankietą jako pierwszy, pozostałe jako kolejne kroki) + data kontaktu w dniu 30.
...
- [ ] Ankieta po sesji gotowa PRZED sesją (z pytaniem o wybór tematu warsztatu 2), link/QR pod ręką.
...
- **Maciej (jedyny z licencjami, brak odpowiedzi w ankiecie):** ryzyko „to nie o mnie”. Antidotum: demo 3 jest jego, Terrain mówi do niego wprost, warsztat „Linia graficzna” na slajdzie 32.
